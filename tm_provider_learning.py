...
# v4.14.6.100-data-dir-resolver: lazy, central, pointer-driven paths.
def _data_dir() -> Path:
    import tm_paths
    return tm_paths.get_data_dir()


def _store() -> Path:
    return _data_dir() / "provider_learning.json"


def _log_path() -> Path:
    return _data_dir() / "provider_learning.log"
