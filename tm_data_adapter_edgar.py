...
def _read_sec_contact_from_config() -> str:
    ...
    try:
        ...
        cfg_path = _Path(__file__).resolve().parent / 'data' / 'config.json'
...
# session; every restart re-resolves the same dead tickers (ADRO, AKE,
# BFA, BFB, GTXI, HIFS, HNR, INH, NBN, PDLI, SEEL, TOWN, UBQU, BRZV) and
